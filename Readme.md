...
WORKDIR /src
COPY ["LeadSquared.ApplicationProcess.csproj", "LeadSquared.ApplicationProcess/"]
RUN dotnet restore "LeadSquared.ApplicationProcess/LeadSquared.ApplicationProcess.csproj"

WORKDIR "/src/LeadSquared.ApplicationProcess"
COPY . .
RUN dotnet build "LeadSquared.ApplicationProcess.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "LeadSquared.ApplicationProcess.csproj" \
...
Execute unit tests
```
    cd "LeadSquared.ApplicationProcess/test/LeadSquared.ApplicationProcess.Tests"
    dotnet test
```

Deploy application
```
    cd "LeadSquared.ApplicationProcess/src/LeadSquared.ApplicationProcess"
